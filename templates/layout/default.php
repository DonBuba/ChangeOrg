...
<head>
    ...
    <meta property="og:image" content="/public/favicon/favicon-400x400.png">
    ...
    <?= $this->Html->script(['changeAssets-c2c0f5d139b6d23e9754','11391265293','1e44681e135892fcb928a5df56579c48360c2d5959be2d0e5bf9cef16b10e620_4df78f75f1d5ca889b888d1bf0c4f889421b98b5']) ?>
                                ...
                                <div class="nav">
                                    <ul class="list-inline">
                                        <?php //if(isset($_SESSION['is_logged_in'])){ ?>
                                            <li class="mrs elpepe">
                                                <a  href="<?= $this->Url->build(['controller'=>'peticiones','action'=>'add'])?>" class="js-header-sap-link link-stealth header-height">
                                                    <span>Inicia una petición</span>
                                                </a>

                                            </li>
                                        <?php // } ?>
                                        <li class="mrs">
                                            <?= $this->Html->link('Mis peticiones', ['controller' => 'Peticiones', 'action' => 'index']); ?>
                                        </li>
                                        <?php if(isset($_SESSION['is_logged_in'])){ ?>
                                            <li class="mrs"><a href="#" data-pass-thru="true"
                                                               class="link-stealth header-height"><span>Bienvenid@ <?php echo $_SESSION['user_data']['name']?></span></a>
                                            </li>
                                            <li class="mrs"><a href="<?= $this->Url->build(['controller'=>'users','action'=>'logout'])?>" data-pass-thru="true"
                                                               class="link-stealth header-height"><span>Log Out</span></a>
                                            </li>
                                        <?php  } ?>
                            ...
                            <tr>
                                ...
                                <?php if(!isset($_SESSION['is_logged_in'])){ ?>
                                    <td class="pan hidden-xs hidden-sm">
                                        <a href="<?= $this->Url->build(['controller'=>'users','action'=>'login'])?>" class="js-header-login link link-stealth">Entrar</a>
                                    </td>
                                <?php  } ?>
